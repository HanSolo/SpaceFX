...
public class Config {
    ...
    public static final double      ASTEROID_EXPLOSION_FRAME_WIDTH      = 256 * SCALING_FACTOR;
    public static final double      ASTEROID_EXPLOSION_FRAME_HEIGHT     = 256 * SCALING_FACTOR;
    public static final double      ASTEROID_EXPLOSION_FRAME_CENTER     = 256 * SCALING_FACTOR * 0.5;
