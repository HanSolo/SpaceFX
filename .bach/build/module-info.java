...
@ProjectInfo(
    ...
    externalModules =
        @ExternalModules(
            links = {
              @Link(module = "jpro.webapi", to = "https://sandec.bintray.com/repo/com/sandec/jpro/jpro-webapi/2020.1.1/jpro-webapi-2020.1.1.jar"),
              @Link(module = "one.jpro.sound", to = "https://sandec.bintray.com/repo/one/jpro/one.jpro.sound/0.1.0/one.jpro.sound-0.1.0.jar")
            }
        )
)
module build {
